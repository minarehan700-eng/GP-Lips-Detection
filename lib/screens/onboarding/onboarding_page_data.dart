...
class OnboardingPageData { // بيانات صفحة واحدة في onboarding
  const OnboardingPageData({ // مُنشئ
    required this.icon, // أيقونة
    required this.title, // عنوان
    required this.body, // نص توضيحي
    this.bullets = const [], // نقاط اختيارية
  }); //
  ...
  static const pages = [ // الصفحات الثلاث
    OnboardingPageData( // صفحة 1
